...
なるとさん作のPSG用 高速・高機能音源ドライバ 「NDP」  
https://ndp.squares.net/web/

2025年5月生まれの新しい音源ドライバです。

- PSG3チャンネル+リズムチャンネル独立指定
- セルフディレイ支援
などが目玉です。

過去の音源ドライバのLFOやソフトウェアエンベロープはもちろん搭載しています。

非常に使いやすいエディタもついていて、編集・演奏確認が非常に楽です。

エディタにKSSをドロップするとKSSを演奏してくれたりもします。
