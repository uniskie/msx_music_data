...
OpenMSXに合わせて音量調整しました。

なるとさんのアドバイスによって、SCC波形の振幅を半減し、音量も下げ、あわせてソフトウェアエンベロープのAR、DR、SRを短くし、SLも少し上げてあります。  
SCCの音源分解能は5分の3程度に下げてますが、バランスはとれたような気がします。

またベース音量を一度下げたら、みなみさんが寂しがったし、私も最大で良い気がしてきたので初期の最大音量に戻してます。
